...
c.color_area = [153, 15, 36]./255; c.color_line =  [153, 15, 36]./255; c.x_axis = [1:length(dFoF_rel_Stim_norm_all)]./d.sampling_rate-1; c.error = 'sem'; c.handle = gcf; c.alpha = 0.5; c.line_width = 2;  % define plot appearance
