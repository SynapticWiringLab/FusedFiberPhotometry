...
%% define  data files
FP_file =   'G:\Alex\manuscripts\FusedFiberPhotometry_CellMethRep\02_final_submission\data\Figure_6\F\NIRGeco_Chrimson-2021-11-09-183150.ppd'; 
NI_file =   'G:\Alex\manuscripts\FusedFiberPhotometry_CellMethRep\02_final_submission\data\Figure_6\F\VRdata_NIRGeco_Chrimson_20211109184118.mat';
...
c.color_area = [153, 15, 36]./255; c.color_line =  [153, 15, 36]./255; c.x_axis = [1:length(d.dFoF_rel_Stim_norm)]./d.sampling_rate-1; c.error = 'sem'; c.handle = gcf; c.alpha = 0.5; c.line_width = 2;  % define plot appearance
