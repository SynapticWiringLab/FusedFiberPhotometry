...
%% define data files
path = 'G:\Alex\manuscripts\FusedFiberPhotometry_CellMethRep\02_final_submission\data\Figure_S4\H\';

pupil = 'video0133 19-01-46_ds_DLC_tracking.mat';
photometry = '25417_laser-2022-08-19-190150.ppd';
NIfile = 'VRdata_25417_laser_20220819192556.mat';
...
%% create figure
xwin = [14.2 16.2]; % define time window for raw traces (can be arbitratry)
