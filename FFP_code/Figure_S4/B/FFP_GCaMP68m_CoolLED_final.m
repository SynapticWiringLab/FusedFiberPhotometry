...
%% define data files
path = data_location + '\FFP_data\Figure_S4\B\';
...
power_FFC1 = 128;              % in µW; excitation power for the first channel (470 nm)
power_FFC2 = 180;              % in µW; excitation power for the second channel (405 nm)
