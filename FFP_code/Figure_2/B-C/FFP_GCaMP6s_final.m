...
%% define data files
path = 'G:\Alex\manuscripts\FusedFiberPhotometry_CellMethRep\02_final_submission\data\Figure_2\B-C\';

pupil = '671_16-52-45_ds_DLC_tracking.mat';
photometry = '671_FFC50-202-2021-06-08-165248.ppd';
AFFile = 'FFC_AF50-2021-06-08-165055.ppd';
NIfile = 'VRdata_671_FFC50_20210608170444.mat';

power_FFC1 = 50.2;              % in µW; excitation power for the first channel (470 nm)
power_FFC2 = 54.6;              % in µW; excitation power for the second channel (405 nm)
...
%% create figure
xwin = [2 4]; % define time window for raw traces
